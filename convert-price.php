 ...
 * Nov. 2013
 * 
 * This code is used to call an API (RESTful) service of Bluesnap that converts a price to a different currency
...
*/
$fromCurrency = $_REQUEST['from-currency'];
$toCurrency = $_REQUEST['to-currency'];
$fromAmount = $_REQUEST['from-amount'];


/**
 * Initialize handle and set options
*/
$url = "https://sandbox.plimus.com/services/2/tools/currency-convertor?from=".$fromCurrency."&to=".$toCurrency."&amount=".$fromAmount;
