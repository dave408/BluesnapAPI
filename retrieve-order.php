 ...
 * Nov. 2013
 * 
 * This code is used to call an API (RESTful) service of Bluesnap that retrieves order-information.
...
curl_setopt($ch, CURLOPT_URL, "https://sandbox.plimus.com/services/2/orders/".$orderId); 
