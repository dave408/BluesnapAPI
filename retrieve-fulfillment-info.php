 ...
 * Nov. 2013
 * 
 * This code is used to call an API (RESTful) service of Bluesnap that retrieves fulfillment information.
...
$download_license = 'download-links';


/**
 * Initialize handle and set options
*/
$url = "https://sandbox.plimus.com/services/2/orders/".$orderId."/fulfillment/".$download_license;
$ch = curl_init();
