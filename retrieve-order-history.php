 ...
 * Nov. 2013
 * 
 * This code is used to call an API (RESTful) service of Bluesnap that retrieves the order-history of a shopper.
 ...
 */
$url = 'https://sandbox.plimus.com/services/2/tools/order-history-retriever?fullDescription=true&shopperid='.$shopperId;
